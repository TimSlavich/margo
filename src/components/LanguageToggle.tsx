...
const LanguageToggle = () => {
  ...
  useEffect(() => {
    ...
    const lightSections = ['process'].map((id) => document.getElementById(id)).filter(Boolean);
  ...
  return (
    <div
      ref={ref}
      className={`fixed top-6 right-6 z-50 flex items-center gap-2 luxury-label transition-colors duration-300 ${
